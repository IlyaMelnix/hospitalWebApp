    ...
    <c:forEach var="user" items="${users}">
        <li>
            <div class="collapsible-header grey lighten-5">
                ...
                <c:if test="${user.idstatus == 0}"><i class="material-icons">person_outline</i></c:if>
                <c:if test="${user.idstatus == 1}"><i class="material-icons">person</i></c:if>
                <c:if test="${user.idstatus == 2}"><i class="material-icons">add_circle_outline</i></c:if>
                <c:if test="${user.idstatus == 3}"><i class="material-icons">add_circle</i></c:if>
                    ...
                    <div class="row">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <h6 class="light">Пользователю ещё не были назначены операции.</h6>
